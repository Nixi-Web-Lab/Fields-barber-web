...
export const getMetadata = (locale: 'es' | 'en'): Metadata => {
  ...
  return {
    metadataBase: new URL('https://fieldsbarbers.com'),
    title: {
      default: isSpanish
    ...
    keywords: isSpanish
      ? ['barbería córdoba', 'barbero profesional córdoba', 'corte de pelo hombre córdoba', 'arreglo barba córdoba', 'barbería inglés córdoba', 'fields barbers']
      : ['barber córdoba', 'english speaking barber spain', 'barber shop córdoba', 'mens haircut córdoba', 'beard trim córdoba', 'fields barbers'],
