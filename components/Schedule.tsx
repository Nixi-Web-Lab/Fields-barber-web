      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-dark rounded-lg p-8 border border-gold/20"
          >
            ...
            <div className="space-y-4">
              {scheduleData.map((day, index) => (
                ...
                >
                  <span className={`font-medium ${day.open ? 'text-white' : 'text-gray-custom'}`}>
                    {day.day}
                  </span>
                  <span className={day.open ? 'text-gold' : 'text-gray-custom'}>
                    {day.hours}
                  </span>
                </div>
              ))}
